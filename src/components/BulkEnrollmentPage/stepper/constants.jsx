...
export const ADD_PROGRAMS_STEP = 'chooseCourses';
export const ADD_PROGRAMS_TITLE = 'Add Programs';
...
export const ADD_PROGRAMS_DESCRIPTION = 'By enrolling your learners in programs, you connect your'
                                      + ' learning community with the content that matters most '
                                      + 'to them, and take the guesswork out of getting started '
                                      + 'on the edX platform. To begin, select a program from '
...
export const WARNING_ALERT_TITLE_TEXT = 'Too many programs selected';
export const WARNING_ALERT_BODY_TEXT = 'We noticed that you are trying to enroll learners in over 7 '
                                        + 'programs at once - which might be too many for your learners '
