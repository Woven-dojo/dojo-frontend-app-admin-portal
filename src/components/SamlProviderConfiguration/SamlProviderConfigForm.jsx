...
export const REQUIRED_CONFIG_FIELDS = ['entityId', 'metadataSource'];
...
class SamlProviderConfigForm extends React.Component {
  ...
  handleSubmit = async (formData, config) => {
    ...
    // validate the form
    const invalidFields = this.validateProviderConfigForm(
      formData,
      requiredFields,
    );
      ...
      >
        <div className="row">
          <div className="col col-6">
            <ValidationFormGroup for="enabled">
        ...
        <div className="row">
          <div className="col col-4">
            ...
            >
              <label htmlFor="syncLearnerProfileData">
        ...
        <div className="row">
          <div className="col col-4">
            ...
            >
              <label htmlFor="metadataSource">
                Metadata Source<span className="required">*</span>
              </label>
              <Input
                type="text"
                id="metadataSource"
