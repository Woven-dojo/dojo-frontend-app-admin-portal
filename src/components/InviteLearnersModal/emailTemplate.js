...
const emailTemplate = {
  ...
  body: `{ENTERPRISE_NAME} has not partnered with edX to give you an unlimited subscription to learn on edX!  Take the best courses in the most in-demand subject areas and upskill for a new career opportunity.  Earn a professional certificate, start a program or just learn for fun.
